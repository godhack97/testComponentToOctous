...
\Bitrix\Main\EventManager::getInstance()->addEventHandler('main', 'OnSearch', 'OnSearchCheckQuery');
function OnSearchCheckQuery($strQuery){
  if(preg_match('/ка$/i', $strQuery)){
    return str_replace('ka', '', $strQuery);
  }
}
