...
function phoneFormat($phone = '', $convert = true, $trim = true)
{
  global $phoneFormatCodes; // только для примера! При реализации избавиться от глобальной переменной.
  if (empty($phone)) {
      return '';
  }
  ...
  if (strlen($phone) > 7)
  {
    foreach ($phoneFormatCodes as $countryCode=>$data)
    {
