...
<script>
  ...
  console.log('ISDEK_widjet');

//  $(function(){
//    setTimeout(function(){
//      console.log('IPOLSDEK_pvz.inited = '+ IPOLSDEK_pvz.inited);
//      //console.log(IPOLSDEK_pvz.init();
//    }, 0);
//  });
    var IPOLSDEK_pvz = {
        label     : 'ISDEK_widjet',
        ...
        buttonPVZ : '<a href="javascript:void(0);" class="SDEK_selectPVZ black" onclick="IPOLSDEK_pvz.selectPVZ(\'#id#\',\'PVZ\'); return false;"><?=$linkNamePVZ?></a>', // Profiler
        ...
        getPrices: function(){
          ...
          console.log('IPOLSDEK_pvz getPrices');
        ...
        onLoad: function(ajaxAns){
          ...
          console.log('IPOLSDEK_pvz onLoad');
            ...
            for(var i in IPOLSDEK_pvz.deliveries){
                for(var j in IPOLSDEK_pvz.deliveries[i]){
                    ...
                    // CUSTOM: #curier-delivery-ID_DELIVERY_ID36
                    console.log('IPOLSDEK_pvz onLoad 2');
                    if(
						tag.length > 0 && 
						(
              ...
              console.log('IPOLSDEK_pvz onLoad 3');
        ...
        labelPzv: function(i,mode){
          ...
          console.log('IPOLSDEK_pvz labelPzv');
        ...
        loadProfile:function(){
          ...
          console.log('IPOLSDEK_pvz loadProfile');
