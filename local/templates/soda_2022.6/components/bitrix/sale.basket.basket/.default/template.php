...
if (empty($arResult['ERROR_MESSAGE']))
{
    ...
    <div class="hide_empty_top">
      <?include(Main\Application::getDocumentRoot().$templateFolder.'/empty.php');?>
    </div>
    <div class="hide_empty_bottom">
      <h1><?=Loc::getMessage('SALE_BASKET_TITLE')?></h1>
      
      <div class="share-basket cart_sharing">
        <a class="label hover"><?=Loc::getMessage('SALE_BASKET_SHARED')?></a>
        <!-- img src="<?=SITE_TEMPLATE_PATH?>/images/icons/icon-share.svg" -->
      </div>
        ...
        <div id="basket-items-list-container">
          <div id="basket-item-list">
            <table class="basket-table">
              <tr class="head">
                <th class="image"><?=Loc::getMessage('SALE_BASKET_PRODUCT')?></th>
                <th class="desc"><?=Loc::getMessage('SALE_BASKET_DESCRIPPTION')?></th>
                <th class="size"><?=Loc::getMessage('SALE_BASKET_SIZE')?></th>
                <th class="count"><?=Loc::getMessage('SALE_BASKET_QUANTITY')?></th>
                <th class="summa"><?=Loc::getMessage('SALE_BASKET_PRICE')?></th>
                <th class="control"><?=Loc::getMessage('SALE_BASKET_DELETE')?></th>
              </tr>
...
<script type="text/javascript">
  ...
  BX.message({
    'SALE_BASKET_COPY_LINK': '<?=Loc::getMessage('SALE_BASKET_COPY_LINK')?>'
  });
</script>
