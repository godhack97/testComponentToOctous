...
//else
  $arImageCrop = Array('width' => 800, 'height' => 1200);
	...
	$arSrcsetCrop1 = Array('width' => 414, 'height' => 621);
...
if(isset($item['colors'])){
	...
	foreach ($item['colors'] as $kColor => $vColor){
        ...
        '600px' => CFile::ResizeImageGet($item['DETAIL_PICTURE'], $arImageCropMobile2, BX_RESIZE_IMAGE_EXACT, false, false, false, 75)['src'],// $vColor['item']['DETAIL_PICTURE'],
...
<div class="item">
	<div class="item-wrap">
      ...
      <div class="favorite-block">
				<a class="favorite hover js-favorite-button" data-id="<?=$currentItem['id'];?>">
