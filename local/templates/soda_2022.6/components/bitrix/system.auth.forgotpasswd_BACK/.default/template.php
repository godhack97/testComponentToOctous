  ...
  <div class="col">
    ...
    <div class="form">
      ...
      <form name="bform" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
          ...
          <div class="field">
            <input type="text" placeholder="<?=GetMessage("sys_forgot_pass_login")?>" size="40" name="USER_LOGIN" value="<?=$arResult["LAST_LOGIN"]?>" aria-required="true" required="">
        ...
        <div class="description"><?echo GetMessage("sys_forgot_pass_note_email")?></div>
