...
?>
<div class="product-detail" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
  ...
  <div class="images">
      ...
      <div class="product-detail-slider">
        <div class="image-slider">
          <?if(!empty($arResult['PROPERTIES']['VIDEO_IMAGE']['VALUE']) && !empty($arResult['PROPERTIES']['VIDEO_FILES']['VALUE'])):?>
            <div class="image">
              <?$arVideoImage = CFile::ResizeImageGet($arResult['PROPERTIES']['VIDEO_IMAGE']['VALUE'], array('width'=>1960), BX_RESIZE_IMAGE_EXACT); ?>
          ...
          <?if(!empty($arResult['DETAIL_PICTURE']['SRC'])):?>
            <?$arDetailImage = CFile::ResizeImageGet($arResult['DETAIL_PICTURE'], array('width'=>1960), BX_RESIZE_IMAGE_EXACT); ?>
            <div class="image">
          ...
          <?if(!empty($arResult['PROPERTIES']['IMAGES']['VALUE'])):?>
            <?foreach($arResult['PROPERTIES']['IMAGES']['VALUE'] as $imageID):?>
              <?$arImage = CFile::ResizeImageGet($imageID, array('width'=>1960), BX_RESIZE_IMAGE_EXACT); ?>
              <div class="image">
    ...
    <a class="mobile-arrow-back" href="<?=$arResult['SECTION']['SECTION_PAGE_URL']?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/icons/arrow-back.svg"></a>
  </div>
  <div class="info js-sticky-kit-go">
    ...
    <div class="indent">
      ...
      <div class="props">
        <?if(!empty($arResult['PROPERTIES']['ARTICLE']['VALUE'])):?>
          <div class="item">
            ...
            <span class="value"><?=$arResult['PROPERTIES']['ARTICLE']['VALUE']?></span>
          </div>
        <?endif?>
        <?if(!empty($arResult['PROPERTIES']['COLOR']['VALUE'])):?>
          <div class="item">
            ...
            <?if(is_array($arResult['PROPERTIES']['COLOR']['VALUE'])):?>
              <span class="value"><?=implode(', ', $arResult['PROPERTIES']['COLOR']['VALUE']);?></span>
            <?else:?>
      ...
      <?if(!empty($arResult['PROPERTIES']['SIZES']['VALUE'])):?>
        <div class="size">
          <?foreach($arResult['PROPERTIES']['SIZES']['VALUE'] as $itemSizes):?>
              <div class="item"><a
      ...
      <div class="table-size hover">
        ...
        <div class="icon"><img src="<?=SITE_TEMPLATE_PATH?>/images/icons/hanger.svg"></div>
      </div>
      <?if($arResult["CAN_BUY"]):?>
        <a class="ibutton js-addtobasket" data-id="<?=$arResult['ID']?>" data-size="" rel="nofollow"><?echo GetMessage("CATALOG_ADD_TO_BASKET")?></a>
      <?endif?>
        <? //dbgz($arResult['PROPERTIES']['CARE']['VALUE']); 
...
<?
if($arResult["DISPLAY_PROPERTIES"]["CONCOMITANT"]["VALUE"]){
