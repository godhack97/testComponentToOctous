	  ...
	  //if ($USER->IsAdmin()) {
		  if($offer['ITEM_PRICES'][0]['DISCOUNT'] > 0){
			  if($arResult['IS_CUSTOM_DISCOUNT']){
				  $offer['ITEM_PRICES'][0]['BASE_PRICE'] = ($offer['ITEM_PRICES'][0]['RATIO_BASE_PRICE'] + ($offer['ITEM_PRICES'][0]['RATIO_BASE_PRICE']/100*$arResult['CUSTOM_DISCOUNT']));
				  $offer['ITEM_PRICES'][0]['RATIO_BASE_PRICE'] = ($offer['ITEM_PRICES'][0]['RATIO_BASE_PRICE'] + ($offer['ITEM_PRICES'][0]['RATIO_BASE_PRICE']/100*$arResult['CUSTOM_DISCOUNT']));
			  ...
			  if($arResult['IS_CUSTOM_DISCOUNT']){
				  $offer['ITEM_PRICES'][0]['PERCENT'] = true;
