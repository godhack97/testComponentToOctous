    ...
    <div class="info js-sticky-kit-go">
      ...
      <div class="wrapper">
        ...
        <div class="indent">
          ...
          <div class="price">
            <span id='price-old' <?=$arResult['COLOR_SIZES'][$SET_COLOR_ID]['PRICES']['IS_DISCOUNT'] ? 'class="price-old"' : '';?>><?= $arResult['COLOR_SIZES'][$SET_COLOR_ID]['PRICES']['IS_DISCOUNT'] ? $arResult['COLOR_SIZES'][$SET_COLOR_ID]['PRICES']['OLD'] : ''; ?></span><span id="price-current" class="price-current"><?=$arResult['COLOR_SIZES'][$SET_COLOR_ID]['PRICES']['CURRENT']?></span>
          </div>
          ...
          <?if($arResult["CAN_BUY"]):?>
            <div class="mobile-buy mobile-display" data-can-buy="1">
              ...
              <div class="size-module" data-num="1">
                ...
                <?endif?>
	              <?if(!empty($arResult['PROPERTIES']['SIZES_JEANS']['VALUE'])):?>
		              <div class="size">
			              <?foreach($arResult['PROPERTIES']['SIZES_JEANS']['VALUE'] as $keyitemSizes=>$itemSizes):?>
				              <div class="item"><a class="js-addtobasket-go-item hover"
				                                   data-id="<?=$arResult['ID']?>"
				                                   data-elurl="<?=$arResult['DETAIL_PAGE_URL']?>"
				                                   data-propid="<?=$arResult['PROPERTIES']['SIZES_JEANS']['VALUE_ENUM_ID'][$keyitemSizes]?>"
				                                   data-elid="<?=$arResult['ID']?>"
				                                   data-name="<?=$arResult['PROPERTIES']['SIZES_JEANS']['NAME']?>"
				                                   data-code="<?=$arResult['PROPERTIES']['SIZES_JEANS']['CODE']?>"
	              ...
	              <?endif?>
	              <?if(!empty($arResult['PROPERTIES']['SIZES_SHOES']['VALUE'])):?>
		              <div class="size">
			              <?foreach($arResult['PROPERTIES']['SIZES_SHOES']['VALUE'] as $keyitemSizes=>$itemSizes):?>
				              <div class="item"><a class="js-addtobasket-go-item hover"
				                                   data-id="<?=$arResult['ID']?>"
				                                   data-elurl="<?=$arResult['DETAIL_PAGE_URL']?>"
				                                   data-propid="<?=$arResult['PROPERTIES']['SIZES_SHOES']['VALUE_ENUM_ID'][$keyitemSizes]?>"
				                                   data-elid="<?=$arResult['ID']?>"
				                                   data-name="<?=$arResult['PROPERTIES']['SIZES_SHOES']['NAME']?>"
				                                   data-code="<?=$arResult['PROPERTIES']['SIZES_SHOES']['CODE']?>"
            ...
            <?if($arResult["CAN_BUY"]):?>
              ...
              <a class='ibutton js-addtobasket' data-can-buy='1'
                ...
                <?endif ?>
                 ...
                 rel="nofollow"><?= Loc::getMessage('CATALOG_ADD_TO_BASKET') ?>
              </a>
          ...
          <div class="links">
            ...
            <div class="item item-socials">
              ...
              <div class="wrap-share">
                ...
                <div class="ya-share2" data-curtain data-shape="round" data-color-scheme="whiteblack" data-services="vkontakte,telegram,whatsapp"></div>
              </div>
            </div>
          </div>
