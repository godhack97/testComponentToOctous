...
$MESS["main_profile_phone_number"] = "Номер телефона";


$MESS["MAIN_PROFILE_ON_YOUR_ACCOUNT"] = "На вашем счёте";
$MESS["MAIN_PROFILE_POINTS"] = "баллов.";
$MESS["MAIN_PROFILE_AVAILABLE_ORDER"] = "Вам они будут доступны при оформлении заказа.";
$MESS["MAIN_PROFILE_NAME"] = "Ваше имя";
$MESS["MAIN_PROFILE_LAST_NAME"] = "Фамилия";
$MESS["MAIN_PROFILE_LOGIN"] = "Логин";
$MESS["MAIN_PROFILE_EMAIL"] = "E-mail";
$MESS["MAIN_PROFILE_ADDRESS"] = "Адрес";

$MESS["PROFILE_CONFIRM_PHONE"] = "Подтвердить";
$MESS["PROFILE_CONFIRM_PHONE_TITLE"] = "Требуется подтверждение телефонного номера";


$MESS['PROFILE_NEW_PARTNER'] = 'Приглашаем к сотрудничеству новых партнёров. Станьте частью нашей команды и публикуйте свои предложения на нашем сайте, делайте закупки по оптовым ценам. Для начала сотрудничества просим указать ваше юр. лицо.';
$MESS['PROFILE_BECOME_PARTNER'] = 'СТАТЬ ПАРТНЕРОМ';
$MESS['PROFILE_ORGANIZATION'] = 'ОРГАНИЗАЦИЯ';
$MESS['PROFILE_ORGANIZATION_NAME'] = 'Наименование организации';
$MESS['PROFILE_INN'] = 'ИНН';
$MESS['PROFILE_PSRNIE'] = 'ОГРНИП';
$MESS['PROFILE_WORK_STREET'] = 'Юридический адрес';
$MESS['PROFILE_STREET'] = 'Фактический адрес';
$MESS['PROFILE_OKVED'] = 'Основной вид деятельности (ОКВЭД)';
$MESS['PROFILE_BANK'] = 'Банк';
$MESS['PROFILE_SETTLEMENT_ACCOUNT'] = 'Расчетный счет';
$MESS['PROFILE_CORRESPONDENT_ACCOUNT'] = 'Корреспондентский счет';
$MESS['PROFILE_IBIKNN'] = 'БИК';
$MESS['PROFILE_TAXATION'] = 'Налогообложение';
