...
<div class="section-auth">
  <div class="col">
    ...
    <h1><?=Loc::getMessage('PROFILE_CAPTION')?></h1>
    <br>
    ...
    <form class="form" method="post" name="form1" action="<?= $arResult["FORM_TARGET"] ?>"
        ...
        <div class="wrap-buttons-between flex-end">
          <button class="ibutton min-width-50" type="submit" name="save"
  ...
  <div class="col profile-partner">
    <h1><?=Loc::getMessage('PARTNER_CAPTION')?></h1>
    <br>
    
    <div class="partner-form-wrapper<?if($arResult['FLAG_SHOW_PARTNER']):?> accepted<?endif?>">
      <form class="form" method="post" name="became_partner">
        ...
        <div class="partner-form">
          ...
          <?if(in_array(17, CUser::GetUserGroup($USER->GetId())) && $arResult['FLAG_SHOW_PARTNER']):?>
            <div class="domestic-points"><?=Loc::getMessage('PARTNER_STATUS')?></div>
          <?endif?>
          ...
          <div class="wrap-buttons-between flex-end">
            <button class="ibutton partner-save min-width-50" type="submit" name="partner_save" value=""><?=Loc::getMessage('PROFILE_SAVE')?></button>
          </div>
        </div>
      </form>
    </div>
