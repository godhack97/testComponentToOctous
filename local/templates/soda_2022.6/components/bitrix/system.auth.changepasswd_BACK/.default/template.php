      ...
      <?if($arResult["SHOW_FORM"]):?>
        ...
        <form method="post" action="<?=$arResult["AUTH_FORM"]?>" name="bform">
          ...
          <?if($arResult["PHONE_REGISTRATION"]):?>
            ...
            <div class="field">
              <input type="text" placeholder="<?echo GetMessage("sys_auth_chpass_phone_number")?>" size="40" value="<?=htmlspecialcharsbx($arResult["USER_PHONE_NUMBER"])?>" disabled="disabled">
              <input type="hidden" name="USER_PHONE_NUMBER" value="<?=htmlspecialcharsbx($arResult["USER_PHONE_NUMBER"])?>" />
            </div>
            <div class="field">
              <input type="text" placeholder="<?echo GetMessage("sys_auth_chpass_code")?>" name="USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" autocomplete="off" required="" aria-required="true">
            </div>

          <?else:?>
              
            <div class="field">
              <input type="text" placeholder=" " name="USER_LOGIN" class="field-style" id="FIELD_USER_LOGIN" maxlength="50" value="<?=$arResult["LAST_LOGIN"]?>" required="" aria-required="true">
              <label class="placeholder" for="FIELD_USER_LOGIN"><?=GetMessage("AUTH_LOGIN_CUSTOM")?></label>
            </div>
            <div class="field">
              <input type="text" placeholder=" " name="USER_CHECKWORD" id="FIELD_USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" autocomplete="off" required="" aria-required="true">
