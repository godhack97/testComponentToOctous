            ...
            <?php
              while ($arResultSearch = $obSearch->GetNext()) {
                ...
                <div class="search-page-item">
                  <a class="black hover"
                     href="<?= $arResultSearch['URL']; ?>"><?= $arResultSearch['TITLE_FORMATED']; ?></a>
...
<div class="lazyload-items-spinner">
  <div class='group'>
    ...
    <!-- div class='bigSqr'>
      <div class='square square-first'></div>
      <div class='square square-second'></div>
      <div class='square square-third'></div>
      <div class='square square-fourth'></div>
    </div -->
  </div>
</div>
                  ...
                  for (; params.currentPage <= lastPageSession; params.currentPage++) {
                    ...
                    $.ajax({
                      ...
                      success: function (data) {
                        ...
                        console.log(sessionStorage.getItem('lastPageItems'));
        ...
        $(document).ready(function () {
            ...
            if($('.ajax_load_items').hasClass('type-3')){
                let timerId = setTimeout(function tick() {
                    offsetWrap = $('footer .wrapper').offset();
                    let startLoad = offsetWrap.top - ($('.item-wrapper').height() * 2);
