...
$this->addExternalJS(SITE_TEMPLATE_PATH .'/components/bitrix/catalog.element/.default/swipe.js');
...
?>
    ...
    if(htmlspecialcharsbx($_REQUEST['setColor']))
      $SET_COLOR = htmlspecialcharsbx($_REQUEST['setColor']);
      ...
      $component
		...
		if ($elementId > 0)
		{
			...
			if (!empty($recommendedData))
			{
                ...
                && !empty($recommendedData['IBLOCK_LINK']) || !empty($recommendedData['ALL_LINK']))
				{
					?>
