...
// $this->addExternalJS(SITE_TEMPLATE_PATH .'/js/Draggable.min.js');
$this->addExternalJS(SITE_TEMPLATE_PATH .'/libs/draggable/Draggable.min.js');
// $this->addExternalJS(SITE_TEMPLATE_PATH .'/libs/draggable/ThrowPropsPlugin.min.js');
$this->addExternalJS(SITE_TEMPLATE_PATH .'/libs/slick/slick.min.js');

$this->addExternalJS(SITE_TEMPLATE_PATH .'/js/TweenMax.min.js');
$this->addExternalJS(SITE_TEMPLATE_PATH .'/js/share.mobile.js');
...
$this->addExternalCss(SITE_TEMPLATE_PATH .'/css/table-sizes.css', true);

$this->addExternalJS(SITE_TEMPLATE_PATH .'/components/bitrix/catalog.element/template/swipe.js');
...
?>
      ...
      'IS_AUTH' => ($USER->IsAuthorized() ? 'Y' : 'N'),
        ...
        $componentElementParams['IS_PARTNERS'] = in_array(GROUP_USER_PARTNERS,$arGroups);


    // $templateElement = 'template'; //($USER->IsAdmin() ? 'template' : '');
		$templateElement = 'new-template';
