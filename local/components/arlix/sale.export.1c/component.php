...
//custom
//elseif(COption::GetOptionString("sale", "secure_1c_exchange", "N") == "Y" && !check_bitrix_sessid() && false)
{
...
else
{
	...
	elseif($_GET["mode"] == "import" && $ABS_FILE_NAME)
	{
		if(file_exists($ABS_FILE_NAME) && filesize($ABS_FILE_NAME)>0)
		{
             ...
             * ���� �� ��� ��������� ���� �������� �24+���, �� ����������� ����� ������� (�.�. ������ CRM �� ����������)
             * ���� �� �24 ��������� ���� �������� �24+���, �� ����������� ����� ������� (�.�. ������ CRM ����������)
             * ���� �� ��� ����������� ������ +�24, ���������� ����� IS_SALE_CRM_SITE_MASTER_FINISH � ���������� ������������ ������
             * ���� �� �24 ����������� ������ +���, ���������� ����� IS_SALE_BSM_SITE_MASTER_FINISH � ���������� ������������ �����,
             *     � ��� ������� ������� ���������� ��������� ������ �� rest
             * */
			//B24 -> +BUS.wizard
