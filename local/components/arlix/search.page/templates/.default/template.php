...
<div class="search-page form" style="display: none">
  <form action="" method="get">
    <div class="field">
      ...
      <?else:?>
        <input type="text" name="q" class="query" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
      <?endif;?>
        <input type="submit" class="send hover" value="<?=GetMessage("SEARCH_GO")?>" />
