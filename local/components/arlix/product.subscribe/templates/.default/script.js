BX.ready(function() {
  ...
  $(".subscribe-not-auth").click(function(){
    ...
    $('.content-popup-product-subscribe #popup-form-field-phone').inputmasks(maskPhoneOpts);
    console.log('console ".subscribe-not-auth"');
  });
  ...
  $("form[name=product-subscribe]").submit(function(event){
    ...
    for(var key in dataObj){
      if(dataObj[key].length > 0 && !checkOneValue && key !== 'productId'){
        checkOneValue = true;
      }
    }
