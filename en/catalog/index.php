...
<?$APPLICATION->IncludeComponent(
    ...
    "CURRENCY_ID" => strtoupper($currencyConvert),
		...
		"GIFTS_MAIN_PRODUCT_DETAIL_BLOCK_TITLE" => "Select one of the items to receive a gift",
      ...
      2 => "PROTSENT_IZMENENIYA_TSENY",
		...
		"LOAD_ON_SCROLL" => "N",
		"MESSAGE_404" => "",
		"MESS_BTN_ADD_TO_BASKET" => "Add to basket",
		"MESS_BTN_BUY" => "Buy",
		"MESS_BTN_COMPARE" => "Comparison",
		...
		"MESS_PRICE_RANGES_TITLE" => "Price",
		"MESS_PROPERTIES_TAB" => "Specifications",
